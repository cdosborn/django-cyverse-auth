...
def globus_validate_code(request):
    ...
    auth_token = get_or_create_user_and_token(user_profile, user_access_token, expiry_date, issuer)
    return auth_token
...
def create_user_token_from_globus_profile(profile, access_token):
    ...
    auth_token = get_or_create_user_and_token(profile_dict, access_token, expiry, issuer)
    return auth_token
